...
<header class="w-full px-7 py-5 shadow-lg">
    <nav class="w-full grid grid-flow-col justify-between items-center overflow-hidden">
        ...
        <div id="header-nav" class="h-full w-60 lg:w-fit py-10 px-10 lg:p-0 absolute lg:static top-0
        flex flex-col lg:flex-row gap-3 lg:gap-5 bg-white shadow-lg lg:shadow-none lg:justify-end lg:items-center">
